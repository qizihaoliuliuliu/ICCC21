...
% pos=axis;
% xlabel({'   Avaliable resource(%)   '},'position',[6 14 -1])
% ylabel('Slice requests','position',[-1 8 0])
% zlabel('Reward')
% colormap('Bone')
...
% MMF_reward=fliplr(MMF_reward);
% number=1:10
% optimal_reward=optimal_reward(2:11);
% Greedy_reward=Greedy_reward(2:11);
% MMF_reward=MMF_reward(2:11);
